  ...
  return (
    <div className="w-screen h-screen bg-gray-900 flex items-center flex-col justify-center text-gray-100">
      ...
      <form className="flex flex-col gap-4 items-stretch w-full max-w-[400px] mt-10">
        ...
        <label htmlFor="email" className="flex flex-col gap-3">
          ...
          <TextInput.Root>
            ...
            <TextInput.Input type="email" id="email" placeholder="name@exemple.com"/>
          </TextInput.Root>
        </label>
      ...
      <footer className="flex flex-col items-center gap-4 mt-8">
        ...
        <Text asChild size="sm">
          <a href="" className="text-gray-400 underline hover:text-cyan-300">Não possui uma conta? Crie uma agora!</a>
        </Text>
      </footer>
    </div>
  )
